...
from PointFilter.Pointfilter_Utils import pca_alignment
...
class PointcloudPatchDataset(data.Dataset):
    ...
    def __init__(self, cloud = None, root=None, shapes_list_file=None, patch_radius=0.05, points_per_patch=500,
    ...
    def __getitem__(self, index):
        ...
        # print(shape_ind, patch_ind, noise_shape, patch_radius)
        ...
        if self.train_state == 'evaluation':
            ...
            # print([torch.from_numpy(noise_patch_pts), torch.from_numpy(noise_patch_inv), \
